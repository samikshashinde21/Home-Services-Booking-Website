        ...
        <div class="row visible-md visible-lg">
            ...
            <div class="col-md-3 col-xs-6 col-sm-6">
                ...
                <ul>
                    ...
                    <li><i class="fa fa-check"></i> <a href="service-details/ac-uninstallation.html">Uninstallation</a>
                    </li>
                ...
                <ul class="contact_footer">
                    ...
                    <li>
                        <i class="fa fa-envelope"></i> <a
                            href="mailto:vinayakbirla20@gmail.com">contact@vinayakbirla20@gmail.com</a>
                    </li>
                    <li>
    ...
    <div class="footer-down">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="text-xs-center crtext">&copy; 2023 VB Service. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
